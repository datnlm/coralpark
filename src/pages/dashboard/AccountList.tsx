...
export default function UserList() {
  ...
  const handleAccount = async (userName: string, roleName: string) => {
    try {
      await manageAccount.deleteAccount(userName, roleName).then((respone) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="right">
                            <AccountMoreMenu onDelete={() => handleAccount(userName, roleName)} />
                          </TableCell>
                        </TableRow>
                      );
                    })}
