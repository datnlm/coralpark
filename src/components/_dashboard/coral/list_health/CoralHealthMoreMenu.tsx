...
type CoralHealthMoreMenuProps = {
  onDelete: VoidFunction;
  id: String;
};

export default function CoralHealthMoreMenu({ onDelete, id }: CoralHealthMoreMenuProps) {
    ...
    <>
      ...
      >
        ...
        <MenuItem
          ...
          to={`${PATH_DASHBOARD.coral.root}/health/${id}/edit/`}
